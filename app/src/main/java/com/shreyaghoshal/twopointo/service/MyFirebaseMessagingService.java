package com.shreyaghoshal.twopointo.service;
...
import com.shreyaghoshal.twopointo.utils.NotificationUtils;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void handleNotification(String message) {
        ...
        if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
            ...
            showNotificationMessage(getApplicationContext(), "Shreya Ghoshal", message, "", pushNotification);
